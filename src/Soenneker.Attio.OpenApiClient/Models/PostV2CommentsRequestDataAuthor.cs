...
namespace Soenneker.Attio.OpenApiClient.Models
{
    ...
    public partial class PostV2CommentsRequestDataAuthor : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public PostV2CommentsRequestDataAuthor()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Attio.OpenApiClient.Models.PostV2CommentsRequestDataAuthor"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Attio.OpenApiClient.Models.PostV2CommentsRequestDataAuthor CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Attio.OpenApiClient.Models.PostV2CommentsRequestDataAuthor();
        }
        /// <summary>
