...
namespace Soenneker.Attio.OpenApiClient.Models
{
    ...
    {
        /// <summary>Composed type representation for type <see cref="global::Soenneker.Attio.OpenApiClient.Models.PatchV2ObjectsCompaniesRecordsByRecordId400ResponseCodeAnyOf1"/></summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Attio.OpenApiClient.Models.PatchV2ObjectsCompaniesRecordsByRecordId400ResponseCode"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Attio.OpenApiClient.Models.PatchV2ObjectsCompaniesRecordsByRecordId400ResponseCode CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var result = new global::Soenneker.Attio.OpenApiClient.Models.PatchV2ObjectsCompaniesRecordsByRecordId400ResponseCode();
            if(parseNode.GetEnumValue<global::Soenneker.Attio.OpenApiClient.Models.PatchV2ObjectsCompaniesRecordsByRecordId400ResponseCodeAnyOf1>() is global::Soenneker.Attio.OpenApiClient.Models.PatchV2ObjectsCompaniesRecordsByRecordId400ResponseCodeAnyOf1 patchV2ObjectsCompaniesRecordsByRecordId400ResponseCodeAnyOf1Value)
            {
                result.PatchV2ObjectsCompaniesRecordsByRecordId400ResponseCodeAnyOf1 = patchV2ObjectsCompaniesRecordsByRecordId400ResponseCodeAnyOf1Value;
            }
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            if(PatchV2ObjectsCompaniesRecordsByRecordId400ResponseCodeAnyOf1 != null)
            {
                writer.WriteEnumValue<global::Soenneker.Attio.OpenApiClient.Models.PatchV2ObjectsCompaniesRecordsByRecordId400ResponseCodeAnyOf1>(null, PatchV2ObjectsCompaniesRecordsByRecordId400ResponseCodeAnyOf1);
            }
