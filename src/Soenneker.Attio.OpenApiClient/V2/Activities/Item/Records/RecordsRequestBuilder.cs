...
namespace Soenneker.Attio.OpenApiClient.V2.Activities.Item.Records
{
    ...
    public partial class RecordsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Creates a new activity record, for example one specific phone call.This endpoint is in alpha and may be subject to breaking changes as we gather feedback.Required scopes: `activity_record:read-write`, `activity_configuration:read`, `object_configuration:read`, `record_permission:read`.Supported token levels: `workspace`, `user`.
        /// </summary>
